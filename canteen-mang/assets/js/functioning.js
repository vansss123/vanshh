  ...
  var firebaseConfig = {
    ...
    authDomain: "AIzaSyCDf2vMgsWxm6bThXsEm7O2iakCJ-xce14",
  ...
  class signUpMethods {
    ...
    static authRedirecting() {
      window.setTimeout(() => {
        window.location.replace('https://vamacanteen.netlify.app/client-side');
      }, 500)
    }
    ...
    firebaseAuthRedirect(){
      firebase.auth().onAuthStateChanged(function(user) {
        ...
        user ?  window.location.replace('https://vamacanteen.netlify.app/client-side') : console.log('none');
      });
    }
  }
      ...
      logout.forEach(btn => {
        btn.addEventListener('click', (e) => {
          ...
          firebase.auth().signOut().then(() => {
            window.location.replace("https://vamacanteen.netlify.app/index.html")
          });
        });
      })
    }
